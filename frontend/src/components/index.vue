        ...
        <aside class="main-sidebar">
          ...
          <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                <a href="#">
                  <i class="fa fa-dashboard"></i> <span>展开</span>
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <router-link to="/deviceCatalog">
                      <i class="fa fa-circle-o"></i> page1
                    </router-link>
                  </li>
                  <li>
                    <router-link to="/deviceCatalog2">
                      <i class="fa fa-circle-o"></i> page2
                    </router-link>
                  </li>
                </ul>
              </li>
              <li>
                <router-link to="/general">
                  <i class="fa fa-th"></i> <span>表单页面</span>
                  <span class="pull-right-container">
              ...
              <li>
                <router-link to="/ticketInfo">
                  <i class="fa fa-th"></i> <span>火车票信息</span>
                  <span class="pull-right-container">
                    <small class="label pull-right bg-green">Hot</small>
                  </span>
                </router-link>
              ...
              <li>
                <router-link to="/map">
                  <i class="fa fa-th"></i> <span>地图显示</span>
                  <span class="pull-right-container">

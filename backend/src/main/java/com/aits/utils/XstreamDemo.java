...
public class XstreamDemo {
    public static void main(String[] args) {
        ...
        xstream.processAnnotations(XStreamDemo.class);
       ...
       // xstream.alias("Good",Good.class);
        ...
        //Person person= (Person) xstream.fromXML("<Person><name>673</name><address>上海市</address><age>27</age></Person>");
          String xsm="<XStreamDemo><id>x1</id><name>报文1</name><Header><id>h1</id><hName>头部1</hName></Header>" +
                  "<Header><id>h2</id><hName>头部2</hName></Header></XStreamDemo>";
